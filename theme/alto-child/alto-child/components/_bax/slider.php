  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-3 col-xl-5">
        ...
        <div class="call-to-action"> <a href="<?php the_field('primary_button_url');?>" class="btn primary-button fill col-sm-12 col-xl-5" role="button">Discover Our History</a> <a href="<?php the_field('secondary_button_url');?>" class="btn secondary-button outline col-sm-12 col-xl-5" role="button">Shop Our Wines</a> 
      ...
      <!-- Inner -->
      <div class="col-sx-12 col-md-3 col-xl-3">
      ...
      <div class="col-md-3 col-xl-3"> <img
        src="https://alto.co.za/wp-content/uploads/2021/02/bertho-van-der-westhuizen-signature.png"
        class="d-block w-30"
        alt="..."
      /> </div>
    </div>
